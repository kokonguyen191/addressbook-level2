...
> 
> ADDRESS must be in this format: 'Block, Street, Unit, Postal Code' without quotes where block is a
> number smaller than 1000, unit is in this format '#x-y' without quotes where x and y are two numbers,
> postal code is a 6-digit number. Example of an address: **123, Clementi Ave 3, #12-34, 231534**
> 
...
* `add Betsy Crowe pp/1234567 e/betsycrowe@gmail.com pa/666, Lucifera 13, #4444, 666666 t/criminal t/friend`
